...
public class CustomerUI extends javax.swing.JFrame {
    ...
    public void showList() {
        new CustomerDAO().showDetail(tblGrid);
    }

    public void searchList() {
        new CustomerDAO().searchDetail(tblGrid, txtSearch.getText());
    }

    public void insertItem() {

        try {
            Customer in = new Model.Customer(txtMaNC.getText(),
                    txtPass.getText(),
                    txtMaPM.getText(),
                    Float.parseFloat(txtTienNap.getText()));
            new CustomerDAO().insertItem(in);
        } catch (Exception e) {
        }
    }
    public void addMoreMoney() {
        Customer add = new Customer(
                ...
                txtMaPM.getText(),
                Float.parseFloat(txtTienNap.getText()));
        new CustomerDAO().addMoreMoney(add);
    }


    public void updateItem() {
        Customer ud = new Customer(txtMaNC.getText(),
                txtPass.getText(),
                txtMaPM.getText(),
                Float.parseFloat(txtTienNap.getText()));
        new CustomerDAO().updateItem(ud);
    }

    public void deleteItem() {
        int r = JOptionPane.showConfirmDialog(null, "Do you want Delete?");
        if (r == JOptionPane.YES_OPTION) {
            Customer del = new Model.Customer(txtMaNC.getText(),
                    txtPass.getText(),
                    txtMaPM.getText(),
                    Float.parseFloat(txtTienNap.getText()));
            new CustomerDAO().deleteItem(del);
        }
    }
    ...
    public void showDetail(int index) {
        Customer cd = new CustomerDAO().hienthi(tblGrid, index);
        txtMaNC.setText(cd.getMaNC());
        txtPass.setText(cd.getMatKhau());
        txtMaPM.setText(cd.getMaPM());
        txtTienNap.setText(String.valueOf(cd.getTienNap()));

    }

    public boolean check() {
        if (txtMaPM.getText().isEmpty() && txtMaNC.getText().isEmpty()
                && txtPass.getText().isEmpty()
                && txtTienNap.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập dữ liệu");
        } else if (txtMaNC.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Không được để trống mã người chơi");
        } else if (!txtTienNap.getText().matches("[0-9]{5,6}")) {
        ...
        } else if (txtTienNap.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Không được để trống số tiền nạp");
        } else {
    ...
    private void initComponents() {
        ...
        btnAddMore.setBackground(new java.awt.Color(204, 204, 204));
        btnAddMore.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnAddMore.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/Dollar.png"))); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnAddMore, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(107, 107, 107)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(btnAddMore, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel14.setText("Mã người chơi:");
        ...
        jPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel12Layout.createSequentialGroup()
                ...
                .addComponent(txtMaNC, javax.swing.GroupLayout.PREFERRED_SIZE, 515, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        jPanel12Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel12Layout.createSequentialGroup()
                ...
                .addGroup(jPanel12Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel14)
                    .addComponent(txtMaNC, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel11Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(txtPass, javax.swing.GroupLayout.PREFERRED_SIZE, 516, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        jPanel14Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel14Layout.createSequentialGroup()
                ...
                .addComponent(txtTienNap, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        tblGrid.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã người chơi", "Mật khẩu", "Mã phòng máy", "Số tiền nạp"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerUI.class
